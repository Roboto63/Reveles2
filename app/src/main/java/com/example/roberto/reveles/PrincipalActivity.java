...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<uppostimages,uppostimagesviewHolder>firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<uppostimages, uppostimagesviewHolder>(
                uppostimages.class, R.layout.uppostimages , uppostimagesviewHolder.class , databaseList
        ) {
            @Override
            protected void populateViewHolder(uppostimagesviewHolder viewHolder, uppostimages model, int position) {
